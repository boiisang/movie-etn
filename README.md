...
It is designed for authorized public-domain, Creative Commons/open, or otherwise properly licensed video streams. The app can load live movie and series metadata from TMDB when a local API config is present, while playback is provided by bundled legal watchable streams unless you add your own licensed media URLs.

## Features

- Clean media catalog and native video playback.
- Watchable public-domain/open movie catalog, including public-domain and Creative Commons sources.
...
TMDB is used only for metadata. The bundled playback URLs use public-domain, Creative Commons, or open media sources for watchable playback. Add only content that you own, created, licensed, or have permission to distribute.
...
Movie Etna and its app source are maintained by Joel Dongthansang. Third-party public-domain, Creative Commons, or open media remains subject to its respective licenses and owners.
